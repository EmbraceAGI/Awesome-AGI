...
|[LocalAGI](https://github.com/EmbraceAGI/LocalAGI)|![GitHub Repo stars](https://badgen.net/github/stars/EmbraceAGI/LocalAGI)|Locally run AGI powered by LLMDA, ChatGLM and more.|基于 LLMDA, ChatGLM 等模型的本地 AGI 项目|
